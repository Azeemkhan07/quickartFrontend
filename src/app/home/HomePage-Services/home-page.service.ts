...
export class HomePageService {
  ...
  getProducts():Observable<IProduct[]>{
    let tempVar = this.http.get<IProduct[]>('https://backendappservice-team2-azeem.azurewebsites.net/api/home/getproducts')
    console.log(tempVar)
    return tempVar
  }
  ...
  PostNewSubscriber(emailID:string):Observable<boolean>{
    ...
    let tempVar = this.http.get<boolean>('https://backendappservice-team2-azeem.azurewebsites.net/api/customer/AddNewSubscriber?emailID='+emailID)
    console.log(tempVar)
    return tempVar
  }
